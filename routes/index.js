...
routes.get('/products/:id/edit/:ProductId',Controller.editProduct)
routes.post('/products/:id/edit/:ProductId',Controller.updateProduct)
routes.get('/products/:id/delete/:ProductId',Controller.deleteProduct)
